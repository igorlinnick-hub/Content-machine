...
- Match the format to the topic: a mechanism topic wants Educational explainer; a self-care / routine topic wants Practical tips; a "should I get this checked" topic wants Warning signs; a widely-believed falsehood wants Myth-busting; a topic where ONE specific correction carries most of the result — and a list would be padded out with advice everyone has already heard — wants One thing; a topic where the standard advice is correct but too general to act on wants Vague vs specific
